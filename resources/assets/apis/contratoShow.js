...
async function filtrar(codigo) {
    ...
    try {
       ...
       document.getElementById('canon').value = response.data.data.inmueble.canon;
       document.getElementById('administracion').value = response.data.data.inmueble.administracion;
