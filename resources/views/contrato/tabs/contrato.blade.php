...
<div class="Container card py-3">
    ...
    <div class="card-header text-dark">Actualizar Contrato <span id="codigoContrato"></span>
        {{-- <button type="button" class="close" data-dismiss="modal">&times;</button> --}}
    </div>

    <div class="">

        <form class="form-row text-left" id="formContratoUpdate" method="post" action="{{route('contrato.update')}}">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 ">
                        ...
                        <input class="form-control form-control-sm" list="inmueble_id" id="customID" autocomplete="off"
                ...
                <div class="form-group col-md-12">
                    <input type="submit" class="btn btn-outline-info  btn-sm " id="btnUpdateContrato" value="Enviar">
