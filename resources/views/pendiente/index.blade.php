...
<div class="card mb-0">
    <div class="card-body  text-justify">
        ...
        <form class="form-row text-left col-md-12" id="formRegisterPendiente" method="Post"
            action="{{route('pendientes.store')}}">
            @csrf
        </form>
    ...
    <div class="mb-5">
        <div class="card-body  text-justify" id="pendientesDraw">
        </div>
    </div>
</div>
...
@stop
@push('scripts')
<script async src="{{ asset('/apis/getDataPendiente.js') }}"></script>
@endpush