    ...
    <div class="card-body  text-justify" id="descuentosDraw">
        ...
        <div class="row mx-auto text-center d-flex justify-content-center">
            <div class="form-group">
                <label class=" text-dark">Identificación Arrendatario</label>
        ...
        <form class="form-row text-left col-md-12" id="formRegisterPagoRecibido" method="Post"
...
@stop
@push('scripts')
<script async src="{{ asset('/apis/getDataPagoRecibido.js') }}"></script>
@endpush