<div class="modal fade " tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal
    id="modalArrendatarioRegister">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content py-3 ">

            <div class="card-header text-dark">Registrar Arrendatario
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form class="form-row text-left" id="formArrendatarioRegister" method=""
                    action="{{route('arrendatarios.store')}}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <input type="submit" class="btn btn-outline-info  btn-sm " id="btnSaveArrendatario"
                                    value="Enviar">
