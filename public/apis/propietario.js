...
let btnSavePropietario = document.getElementById("btnSavePropietario");
let btnUpdatePropietario = document.getElementById("btnUpdatePropietario");
...
async function ajaxFormRegisterPropietarios(event) {
    ...
    btnSavePropietario.value = "Enviando...";
    btnSavePropietario.disabled = true
    ...
    btnSavePropietario.disabled = false
}
...
async function ajaxFormUpdatePropietarios(event) {
    ...
    btnUpdatePropietario.value = "Enviando..."
    btnUpdatePropietario.disabled = true
    ...
    btnUpdatePropietario.disabled = false
}
